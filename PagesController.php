...
class PagesController extends Controller
{
    ...
    {
        $buffer_posts_details = json_decode(BufferPosting::with("groupInfo", "accountInfo")->paginate(10)->toJson());
        $paginate = BufferPosting::with("groupInfo", "accountInfo")->paginate(10);
        return view('pages.history')->with('buffer_posts_details', $buffer_posts_details->data)->with('paginate', $paginate);
    }
